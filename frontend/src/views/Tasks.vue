...
const form = reactive({
  ID: 0, Name: '', AccountID: null, SourceFolderID: '0', LocalPath: '/app/strm/', 
  Cron: '0 */2 * * *', Overwrite: false, EncodePath: false, Threads: 4,
  StrmExtensions: 'mp4,mkv,ts,iso', MetaExtensions: 'jpg,jpeg,png,nfo'
})
...
const openModal = (row) => {
  if (row) Object.assign(form, row)
    ...
    ID: 0, Name: '', AccountID: accountOptions.value[0]?.value, SourceFolderID: '0', 
    LocalPath: '/app/strm/', Cron: '0 */2 * * *', Overwrite: false, EncodePath: false, Threads: 4,
    StrmExtensions: 'mp4,mkv,ts,iso', MetaExtensions: 'jpg,jpeg,png,nfo'
  })
